...
('CONFIG_PARAM3_ALIGN2', '0x08003008'::INT, 2, 13, 1, (SELECT id FROM types WHERE type_name='i16'), (SELECT id FROM quantities WHERE quantity_name='velocity'), (SELECT id FROM units WHERE unit_symbol='rpm'), 'Configuration parameter 3 stored in flash'),
