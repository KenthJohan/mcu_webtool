<?php
// Database connection - using DuckDB PHP client
// Install via: composer require satur.io/duckdb-auto
// Or use DuckDB CLI for query execution
...
<body>
    ...
    <script>
        ...
        function loadParameters() {
            fetch('query.php?table=mcu_parameters')
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Promise.all([
                        fetch('query.php?table=types').then(r => r.json()),
                        fetch('query.php?table=quantities').then(r => r.json()),
                        fetch('query.php?table=units').then(r => r.json())
        ...
        function loadDropdowns() {
            ...
            // Load quantities
            fetch('query.php?table=quantities')
            .then(response => response.json())
            .then(data => {
                if (data.success) {
